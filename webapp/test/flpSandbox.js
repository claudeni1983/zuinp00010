					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Central do colaborador",
									"targetURL": "#zuinp00010-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zuinp00010-display": {
								"semanticObject": "zuinp00010",
								"action": "display",
								"description": "Central do colaborador",
								"title": "Central do colaborador",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuinp00010",
									"url": sap.ui.require.toUrl("zuinp00010")
								}
							}
						}
					}
